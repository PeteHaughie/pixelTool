...
class StateManager {
  ...
  // Stroke rasterization and collection helpers have been moved to
  // stroke_utils.pde. StateManager now focuses on state mutations
  // (applyChanges, undo/redo stacks) while helpers build UndoEntry objects.
